"""
Builds report_jobs, triggers Celery task, tracks status. Used by: corresponding endpoint module. This is the only layer allowed to call the AI Engine service.
