              ...
              <div key={idx} className="bg-[#151c2e] border border-[#1e293b] p-4 rounded flex items-center justify-between text-xs gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] bg-amber-500/10 text-amber-400 border border-amber-500/20 px-1 rounded font-mono">
                ...
                <div className="flex-shrink-0">
                  {req.RequestStatus === "Approved" ? (
                    ...
                    <button
                      onClick={() => approveMutation.mutate(req.CollaborationRequestID)}
                      disabled={approveMutation.isPending}
                      className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-white rounded text-[10px] font-bold px-3 py-1.5 uppercase tracking-wider transition-colors flex items-center gap-1 focus:outline-none"
                    >
                      <UserCheck size={12} />
